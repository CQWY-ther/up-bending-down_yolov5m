...
from utils.plots1 import plot_one_box2

from detect_ui import Ui_MainWindow  # 导入detect_ui的界面
...
class UI_Logic_Window(QtWidgets.QMainWindow):
    ...
    def model_init(self):
        ...
        parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp1/weights/best.pt',
